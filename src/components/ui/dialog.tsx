...
// Radix validates DialogTitle via document.getElementById which can't see into
// shadow DOM. This hook places a hidden shim in document.body with the same ID
// so the check passes. The callback ref fires before Radix's useEffect.
